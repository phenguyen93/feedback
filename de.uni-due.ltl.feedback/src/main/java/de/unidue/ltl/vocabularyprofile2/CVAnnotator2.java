...
public class CVAnnotator2 extends JCasAnnotator_ImplBase{
	  ...
	  public void initialize(final UimaContext context) throws ResourceInitializationException {
		...
		for (int i = 0; i < 25; i++) {
			...
			try
	        {
	            ...
	            FileInputStream file = new FileInputStream(new File("D:\\BA\\CV25Rang.xlsx"));
			...
			if (vocab1.containsKey(word)){
				...
				VocabularyProfile vp = new VocabularyProfile(aJCas); 
				  ...
				  if(!t.getPos().getCoarseValue().equals("PUNCT")) {
					  ...
					  vp.setLevel("No"); 
					  vp.addToIndexes(); 
//					  System.out.println(t.getCoveredText()+" ,"+t.getLemma().getValue()+"--"+t.getPos().getCoarseValue()); 
				  }
			}
		}
	}

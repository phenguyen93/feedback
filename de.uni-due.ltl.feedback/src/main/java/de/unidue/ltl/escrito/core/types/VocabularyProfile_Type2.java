 ...
 * @generated */
public class VocabularyProfile_Type2 extends Annotation_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = VocabularyProfile2.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.unidue.ltl.escrito.core.types.VocabularyProfile2");
  ...
  public String getName(int addr) {
      ...
      jcas.throwFeatMissing("name", "de.unidue.ltl.escrito.core.types.VocabularyProfile2");
  ...
  public String getLemma(int addr) {
        if (featOkTst && casFeat_name == null)
      jcas.throwFeatMissing("lemma", "de.unidue.ltl.escrito.core.types.VocabularyProfile2");
  ...
  public String getLevel(int addr) {
      ...
      jcas.throwFeatMissing("level", "de.unidue.ltl.escrito.core.types.VocabularyProfile2");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public VocabularyProfile_Type2(JCas jcas, Type casType) {
    super(jcas, casType);
